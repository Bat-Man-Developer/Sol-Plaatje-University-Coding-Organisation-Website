              ...
              <table class="adminproductstable">
                <thead>
                  <tr>
                    ...
                    <th scope="col">Members Phone Number</th>
                    <th scope="col">Members Programming Language</th>
                  </tr>
                </thead>
                <tbody>
                  ...
                  <tr>
                    ...
                    <td><?php echo $customer['flduseraddress']; ?></td>
                    <td><?php echo $customer['flduseremail']; ?></td>
                    <td><?php echo $customer['flduserphonenumber']; ?></td>
                    <td><?php echo $customer['flduserprogramminglanguage']; ?></td>
                  </tr>
                  <?php } ?>
                </tbody>
              </table>
